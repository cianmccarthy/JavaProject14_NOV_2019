...
public class AddCustomer extends JFrame implements ActionListener
{
    ...
    public AddCustomer(){
        ...
        JLabel town = new JLabel("Address town");
        JLabel county = new JLabel("Address county");
        ...
        header.setBounds(200 + insets.left, 35 + insets.top,
                size.width, size.height);



        size = jt1.getPreferredSize();
        jt1.setBounds(400+ insets.left, 75+ insets.top,
                size.width, size.height);
        size = name.getPreferredSize();
        name.setBounds(325+ insets.left, 75+ insets.top,
                size.width, size.height);

        size = jt2.getPreferredSize();
        jt2.setBounds(400+ insets.left, 100+ insets.top,        //https://docs.oracle.com/javase/tutorial/displayCode.html?code=https://docs.oracle.com/javase/tutorial/uiswing/examples/layout/AbsoluteLayoutDemoProject/src/layout/AbsoluteLayoutDemo.java
                //https://docs.oracle.com/javase/tutorial/uiswing/layout/none.html
                size.width, size.height);
        size = dob.getPreferredSize();
        dob.setBounds(325+ insets.left, 150+ insets.top,
                size.width, size.height);
        ...
        address1.setBounds(325+ insets.left, 200+ insets.top,
                size.width, size.height);

        size = jt4.getPreferredSize();
        jt4.setBounds(400 + insets.left, 200 + insets.top,   //insets act as borders
                size.width, size.height);
        size = address2.getPreferredSize();
        address2.setBounds(325+ insets.left, 200+ insets.top,
                size.width, size.height);

        size = jt5.getPreferredSize();
        jt5.setBounds(400 + insets.left, 200 + insets.top,   //insets act as borders
                size.width, size.height);
        size = town.getPreferredSize();
        town.setBounds(325+ insets.left, 200+ insets.top,
                size.width, size.height);

        size = jt6.getPreferredSize();
        jt6.setBounds(400 + insets.left, 200 + insets.top,   //insets act as borders
                size.width, size.height);
        size = county.getPreferredSize();
        county.setBounds(325+ insets.left, 200+ insets.top,
                size.width, size.height);

        size = jt7.getPreferredSize();
        jt7.setBounds(400 + insets.left, 250 + insets.top,    //getPreferredSize() is a pre written method that gives a suitable size to the components
                size.width, size.height);
        size = phone.getPreferredSize();
        phone.setBounds(256+ insets.left, 250+ insets.top,
                size.width, size.height);

        size = add.getPreferredSize();
        add.setBounds(400+ insets.left, 300+ insets.top,
                size.width, size.height);
